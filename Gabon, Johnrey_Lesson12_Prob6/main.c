    ...
    do
    {
        ...
        case 17:
        {
            ...
            for (int k = 1; k <= terms; k++)
            {
                ...
                if (sign > 0) printf(" + %d^%d/%d!", input,exponent, exponent);
                else printf(" - %d^%d/%d!", input,exponent, exponent);
        ...
        case 19:
        {
            ...
            for (int i = 1; i <= terms; i++)
            {
                ...
                sum += term;
                if (i == 1) printf(" + %.lf", x);
                else printf(" + %.lf^%d/%d", x, i, i); // Print each term
            }
        ...
        case 20:
        {
            // S = 1 * 3/ 2 * 4 * 5 + 2 * 4 / 3 * 5 * 6 + 3 * 5/ 4 * 6 * 7……..
            //n * (n+2)/ (n+1) * (n+3) * (n+4)
            int input;
            do
            {
